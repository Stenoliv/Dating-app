...
?>
        <div class="refresh-index">
            <button class="refresh-btn" onclick="window.location.href='./'">Refresh page</button>
        </div>
<?php
        exit;
...
?>
<div class="refresh-index">
    <button class="refresh-btn" onclick="window.location.href='./'">Next Profiles</button>
</div>